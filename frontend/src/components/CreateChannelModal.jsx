...
import { AlertCircleIcon, HashIcon, XIcon ,LockIcon, UsersIcon} from "lucide-react";
...
const CreateChannelModal = ({  onClose }) => {
  ...
  const validateChannelName = (name) => {
    ...
    if (name.length < 3) return "Channel name must be at least 3 character";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (channelType === "private") {
        ...
        channelData.discoverable = true; //its a custom field that we add and we will use it later
      }
